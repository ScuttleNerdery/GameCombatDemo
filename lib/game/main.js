...
MyGame = ig.Game.extend({
   ...
   curr_player_id: getParameterByName('player_id'),
    ...
    if (this_update.online_refreshing == false) {
      this_update.online_refreshing = true;
      ajax = new ig.Ajax();
      ajax.post( "/online/socket.php", {player_id: this.curr_player_id, player_x: player.pos.x, player_y: player.pos.y}, function(result) {

        // TODO - move players based on the data above

        this_update.online_refreshing = false;
      });
    }
